...
- **Chrome mGBA hardcoded**: `LAYOUT_MGBA_GBA.menu_offset_top = 52` misurato sulla macchina utente (Win10 Pro DPI 100%). Su altre DPI/Windows 11 il valore può differire. Da auto-detect via scansione della prima riga teal del frame catturato.
